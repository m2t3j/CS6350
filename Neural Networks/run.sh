...
echo "3c: The MAP estimatation performed better than the ML estimation in both training and testing. This is due to the MAP inherintley having a regularization penalty due to the prescence of a prior.The hyperparameter v in MAP is analogous toC in SVM, as both regulate model complexity—smaller values enforce stronger regularization, while larger values allow more flexibility. MAP offers a principled Bayesian approach to regularization, whereas C in SVM is an empirical tuning parameter. "